---
title: __preview_file
category: Function
managed_by: Home Manager
source: ~/dotfiles/configs/fish/functions/__preview_file.fish
runtime: ~/.config/fish/functions/__preview_file.fish
tags: fish function
status: active
criticality: normal
...
## Purpose
Custom Fish function `__preview_file`.

## Usage
Inspect the live definition with:
```fish
type __preview_file
functions __preview_file
```

## Modify / Apply
```fish
nvim ~/dotfiles/configs/fish/functions/__preview_file.fish
cd ~/dotfiles
git add configs/fish/functions/__preview_file.fish
hms
```

## Syntax Check
```fish
fish -n ~/dotfiles/configs/fish/functions/__preview_file.fish
```
